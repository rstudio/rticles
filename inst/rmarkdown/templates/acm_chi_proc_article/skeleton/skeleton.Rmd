...
#NOTE: to update the CCSXML (i.e. the code to generate the 'CCS Concepts'), do this directly in the .tex file generated which is generated when you knit the .Rmd file to PDF, then recompile that .tex file to PDF - the CCSXML code is a bit too messy to pass it in from the YAML header.
---
