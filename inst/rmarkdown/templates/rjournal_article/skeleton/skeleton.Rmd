...
## these ensures that figures created within the R session 
## materialise as files (otherwise they are only included in the final PDF)
## Note: If you change the output path, the files are not copied automatically
## to the directory defined via output_dir
