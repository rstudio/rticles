...
- name: Soo Leigh
  address: Department of BBB, University of VVV
  email: author@www.edu
keywords:
  - 3 to 7 keywords
...
This template formats a paper to follow [the guidelines](https://publishingsupport.iopscience.iop.org/questions/latex-template/) for *Institute of Physics* journals. 
...
Text with citations by @cleveland1990stl or in parentheses [@HK06] follow the Harvard system which is accepted by all IOP journals.
