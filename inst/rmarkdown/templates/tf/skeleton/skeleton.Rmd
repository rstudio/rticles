...
[CAVEAT: In the subsections below, the only one that will be typeset correctly that that corresponding to the value specified in the `biblio_style` field of the YAML header in this file.]
