...
title: Title here
authors:
  - {name: Author One, aff: a}
  - {name: Author Two, aff: a} 
  - {name: Author Three, aff: b}   
  - {name: Author Four, aff: a} 
...
affiliations: # Match aff to aff in authors
  - {aff: a, name: First Affiliation}
  - {aff: b, name: Second Affiliation}
  - {aff: c, name: Third Affiliation}
  - {aff: d, name: Fourth Affiliation}
abstract: |
