...
. . Ich kenne das Kind, dem du geholfen hast.\
I.[nom]{.smallcaps} know the child.[acc]{.smallcaps}
[dem.dat]{.smallcaps} you.[nom]{.smallcaps} helped have\
'I know the child that you helped.' . Ich kenne das Kind, dem du nicht
geholfen hast.\
I.[nom]{.smallcaps} know the child.[acc]{.smallcaps}
[dem.dat]{.smallcaps} you.[nom]{.smallcaps} [neg]{.smallcaps} helped
have\
...
language in italics).[^1]

. *German* [@coetsem:2000]\
das Kind, dem du geholfen hast\
the child.[nom]{.smallcaps} [dem.dat]{.smallcaps} you.[nom]{.smallcaps}
helped have\
...
::: {#tbl:table1}
  ...
  Ubykh       nüs^w^              ç'a-nüs^w^           a-ç'a-nüs^w^         'pretty'

  : Morphological containment
:::

[\[tbl:table1\]]{#tbl:table1 label="tbl:table1"}
...
![The Glossa logo (design by Linnea Vanden
Wyngaerd)](glossa "fig:"){#fig:glossalogo width="10cm"}
[\[fig:glossalogo\]]{#fig:glossalogo label="fig:glossalogo"}
...
[^1]: Examples in footnotes are numbered with lower case Roman numerals
    enclosed between brackets:

    . . Colorless green ideas sleep furiously. .̱ \*The child seems
    sleeping.
