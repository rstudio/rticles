...
keywords:
  ...
  - keyword2
  - keyword3
#boxedtext: # Not fully compatible with all document formats
#  - First point
#  - Second point
competing_interests: |
...
output: 
  rticles::oup_article:
    ...
    #document_style: "contemporary" # Can be contemporary, modern, traditional; default contemporary
    #papersize: "large" # Can be large, medium, small; default large
    #citation_package: "default" # Uncomment if using a CSL biblio style; default natbib
...
* @horvath2018dna showed some really cool things. Only seems to work properly if `namedate: TRUE`. 
* This is a well known result [@ji20123d]. 
...
The code below creates a figure. It is included in the output because `echo=TRUE`.
...
You can cross-reference sections and subsections as follows: Section \ref{inserting-r-figures} and Section \ref{a-subsection}.
