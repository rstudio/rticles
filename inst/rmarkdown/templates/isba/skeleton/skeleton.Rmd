...
csl: imsart.csl
output: 
  rticles::isba_article:
    md_extensions: -autolink_bare_uris #keep these off or \printead{} will fail or email addresses
---
...
The following are some other citations to check that the bibliographic style file is working correctly: \citet{akaike}, \citet*{akivarsq}, \citet{dyke},
