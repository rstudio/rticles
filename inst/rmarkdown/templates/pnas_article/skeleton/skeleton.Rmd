...
\dropcap{T}his PNAS journal template is provided to help you write your work in the
...
justification setting.<span data-label="fig:frog"></span>](frog)
...
(x+y)^3&=(x+y)(x+y)^2\\
       ...
       &=x^3+3x^2y+3xy^3+x^3. \end{aligned}$$
