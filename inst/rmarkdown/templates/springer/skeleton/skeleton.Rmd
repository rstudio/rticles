...
classoptions: 
  - sn-basic      
  - pdflatex      # Optional: Compile with pdflatex/xelatex
...
# unnumbered: TRUE # For unnumbered level heads
...
For this, you need to use \verb+\begin{table*}+ \verb+...+ \verb+\end{table*}+ instead of \verb+\begin{table}+ \verb+...+ \verb+\end{table}+ environment. Lengthy tables which do not fit in textwidth should be set as rotated table. For this, you need to use \verb+\begin{sidewaystable}+ \verb+...+ \verb+\end{sidewaystable}+ instead of \verb+\begin{table*}+ \verb+...+ \verb+\end{table*}+ environment. This environment puts tables rotated to single column width. For tables rotated to double column width, use \verb+\begin{sidewaystable*}+ \verb+...+ \verb+\end{sidewaystable*}+.
...
Other environments such as equation and align can be labelled via the \verb+\label{#label}+ command inside or just below the \verb+\caption{}+ command.
...
\verb+Figure \ref{fig:fig1}+, for which it comes up as
``Figure\ \ref{fig:fig1}''.
