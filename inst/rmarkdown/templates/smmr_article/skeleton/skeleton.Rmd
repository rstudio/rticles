...
author: A. Uthor\affilnum{1}, O. Tro\affilnum{2}, O. Vriga\affilnum{1}
affiliation: \affilnum{1}First and third authors’ affiliation \\ \affilnum{2}Second author affiliation
corrauth: "*Corresponding author name, This is sample corresponding address."
email: authorone@protonmail.com
