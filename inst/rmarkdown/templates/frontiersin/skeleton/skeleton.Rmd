...
```{r, graph, echo=TRUE, message=FALSE, fig.height=4, fig.width=4, fig.align='center', fig.cap='Figure caption', out.width = "85mm", out.height = "85mm", fig.show = "hide"}
require("ggplot2")
x <- 0:100
set.seed(999)
...
```{r, Fig. 1, ref.label = "graph", results = "hide", echo = FALSE, message = FALSE, out.height = "85mm", out.width = "85mm", fig.width = 4, fig.height = 4}
