...
- name: A.N. Other
  affilnum: 1
- num: 1
  address: "John Wiley and Sons, Ltd, The Atrium, Southern Gate, Chichester,
West Sussex, PO19 8SQ, UK"
corraddr: some@academic.email.org
authabbr: A.N. Other
date: 2010
year: 2010
abstract: "This paper describes the use of the LaTeX `simauth.cls`
class file for setting papers for Statistics in Medicine using Rmarkdown."
...
* `author`: List containing `name` and `affilnum`

* `address`: List containing `address` and `num` for reference by `author`
