...
relatedversiondetails: # optional, repeat entries as needed
  - classification: "Full Version"
    ...
    cite: "DBLP:books/mk/GrayR93" # optional; requires the BibTeX workflow (citation_package: natbib)
