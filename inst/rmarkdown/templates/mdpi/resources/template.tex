...
\authorcontributions{$institutionalreview$}
$endif$

$if(informedconsent)$
\authorcontributions{$informedconsent$}
$endif$

$if(dataavailability)$
\authorcontributions{$dataavailability$}
$endif$
...
\authorcontributions{$conflictsofinterest$}
$endif$

%% Optional
$if(sampleavailability)$
\authorcontributions{$sampleavailability$}
$endif$
