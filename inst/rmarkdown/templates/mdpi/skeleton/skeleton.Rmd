...
the type of of submission and defaults to `article` but can be replaced with any of the following in Table \ref{Tab:article-type}

```{r article-type, echo = FALSE}
...
knitr::kable(string_to_table(type, 3), 
...
knitr::kable(string_to_table(mdpi_journals, 8),
             col.names = NULL,
             format = "latex",
             booktabs = TRUE, 
