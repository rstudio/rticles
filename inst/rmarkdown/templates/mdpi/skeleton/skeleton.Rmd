...
Note that using default Markdown tables will put these in a normal table environment, you can use knitr::kable with the table.envir argument, for example:
```{r}
knitr::kable(mtcars[1:5, 1:3], table.envir = "specialtable")
