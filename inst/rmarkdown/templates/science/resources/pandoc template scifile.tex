...
1. Is there a way to get Pandoc to render all images at the end? 
...
- solution - get pandoc variable "figures:true" to decide if images should be included in the PDF or not
