#' ACM CHI Extended Abstracts (Conference on Human Factors in Computing Systems) format.
...
#' This template is for CHI Extended Abstracts.
...
#'
#' @export
acm_chi_ea_article <- function(..., keep_tex = TRUE, citation_package = 'natbib'){
  template <- find_resource("acm_chi_ea_article", "template.tex")
