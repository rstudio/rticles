...
#' @export
#' @rdname article
frontiers_article <- function(..., keep_tex = TRUE, extra_dependencies = NULL, citation_package = "natbib") {
  # frontiers requires some CTAN package
  extra_dependencies <- c(extra_dependencies, c("datetime", "fmtcount", "etoolbox", "fcprefix"))
  ...
  pdf_document_format("frontiers", keep_tex = keep_tex, extra_dependencies = extra_dependencies, citation_package = citation_package,...)
}
