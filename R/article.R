...
#'   journals. Adapted from
#'   <https://academic.oup.com/journals/pages/authors/preparing_your_manuscript> and <https://academic.oup.com/icesjms/pages/General_Instructions>.
#'   and the `oup-authoring-template` available on CTAN at
#'   <https://www.ctan.org/pkg/oup-authoring-template>. Note that for `oup_version=0`, `citation_package="default"` by default, whereas for `oup_version=1`, `citation_package="natbib"` by default and `citation_package="biblatex"` is not supported.
#' @export
#' @rdname article
