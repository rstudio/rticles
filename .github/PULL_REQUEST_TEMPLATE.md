...
- [ ] Update README with a link to the newly supported journal. Please include your name as contributor of the template, and a full name of the journal. Follow the other example. 
